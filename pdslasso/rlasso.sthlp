{smcl}
{* *! version 1.0.13  15jan2019}{...}
{hline}
{cmd:help rlasso}{right: lassopack v1.2}
{hline}
...
user-specified lambda0; overrides lasso default lambda = 2c*sqrt(N)*invnormal(1-gamma/(2*p))
...
NB: in versions of {opt rlasso} prior to 1.0.09,
the test statistic S was N*max_j rather than sqrt(N)*max_j as in Chernozhukov et al. ({helpb rlasso##CCK2013:2013}),
...
{phang2}. {stata "rlasso NumProCase Z* BA BL DF, robust lalt corrnum(0) maxpsiiter(100)"}{p_end}
...
{phang2}. {stata "rlasso NumProCase Z*, robust lalt corrnum(0) maxpsiiter(100)"}{p_end}
{phang2}. {stata "di e(p)"}{p_end}
